...
int main(int argc, char **argv) {
    ...
    string settingFile{"./EuRoC.yaml"};
    string leftImgPath{"../../../dataset/EuRoc/V1_02_medium/mav0/cam0/data"};
    string rightImgPath{"../../../dataset/EuRoc/V1_02_medium/mav0/cam1/data"};
    string timesPath{"./EuRoC_TimeStamps/V102.txt"};

    //    if (argc != 6) {
    //        cerr << endl
    //             << "Usage: ./stereo_euroc path_to_vocabulary path_to_settings path_to_left_folder
    ...
    LoadImages(leftImgPath, rightImgPath, timesPath, vstrImageLeft, vstrImageRight, vTimeStamp);
